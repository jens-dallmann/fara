...
verifyRow(rows.item(1), "SecondCommand.anotherCommand","another command description","another command description second parameter")
verifyRow(rows.item(2), "AnyCommand.anyCommand","firstParameterDescription","secondParameterDescription")
